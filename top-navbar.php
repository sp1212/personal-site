...
<nav class="navbar navbar-expand-lg navbar-light nav-blue">
    <div class="container-fluid">
        <!--Site name / logo spot-->
        <a class="navbar-brand brand-text" href="?command=home">TBD</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-hover active" aria-current="page" href="?command=home">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-hover active" aria-current="page" href="?command=home">Explore</a>
                </li>
            </ul>
